...
public interface EventRepository extends JpaRepository<Event, Long>, JpaSpecificationExecutor<Event> {
    ...
    @Query("SELECT e FROM Event e WHERE e.location =:city AND e.isEnabled = true AND e.isExpired = false")
    ...
    @Query("SELECT e FROM Event e WHERE e.name LIKE :keyword OR e.description LIKE :keyword OR e.address LIKE :keyword OR e.keyWords LIKE :keyword OR e" +
           ".location LIKE :keyword OR e.organisation.organisationName LIKE :keyword AND e.isEnabled = true  AND e.isExpired = false")
    ...
    @Query("SELECT e FROM Event e  WHERE e.eventCategory = :type AND e.isEnabled = true  AND e.isExpired = false")
